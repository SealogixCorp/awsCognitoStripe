...
if(!deal) return "Product is not selected"
...
let subscriptionObject =  {
          ...
          priceId: deal.priceId,
          email:billingDetails.email,
          paymentType:deal.paymentType,
          price:deal.price
}
  if(payload.customer)  subscriptionObject.customer = payload.customer ;
console.log(subscriptionObject);
   let res =  await createSubscription(subscriptionObject);
        console.log(res);
        setProcessing(false);
