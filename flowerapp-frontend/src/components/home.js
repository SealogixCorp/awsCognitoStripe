...
function Copyright() {
  return (
    <Typography variant="body2" color="textSecondary" align="center">
      {'Copyright © '}
      <Link color="inherit" href="www.flowerarchitect.club">
  ...
  return (
    ...
    <Grid container spacing={3}>
      ...
      />
       ...
       <Grid item xs={3}>
       {arrangementDeals.map((deal) => (
         // Enterprise card is full width at sm breakpoint
         <Grid item key={deal.title} xs={12} sm={6} md={12} spacing={2} style={{marginBottom:"1em"}} >
           <Card>
             <CardHeader
               title={deal.title}
               subheader={deal.subheader}
             ...
             <CardActions>
                    ...
                    <StripeCheckout
                       ...
                       currency="USD"
                       stripeKey="pk_test_P9SL6JXjtpSUTyNCUFTmWSpD" >
                       <Button fullWidth variant={deal.buttonVariant} color="primary" >
